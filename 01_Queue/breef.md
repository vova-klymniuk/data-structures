...
```
    ...
    Порядок: перший прийшов, перший вийшов (FIFO), тобто елемент даних, який зберігається першим, буде доступний першим. 
    У цьому випадку введення та отримання даних не виконується лише з одного боку. 
    Прикладом черги є будь-яка черга споживачів для ресурсу, де споживач, який прийшов першим, обслуговується першим. 
    З чергою виконуються різні операції, як-от реверсування черги (з або без використання рекурсії), реверсування перших K елементів черги тощо. 
